...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME':'postgres', # ponen el nombre de su base de datos de postgresql
        'USER':'postgres',
        'PASSWORD':os.environ.get("SUPABASE_PASSWORD"), # su contraseña que usan para entrar a postgresql
