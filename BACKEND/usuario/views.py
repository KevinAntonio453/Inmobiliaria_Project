...
from .serializer import UsuarioSerializer, ClienteSerializer, AgenteSerializer, PasswordResetRequestSerializer, PasswordResetVerifyCodeSerializer, SetNewPasswordSerializer, RolSerializer, SolicitudAgenteSerializer,Rol,AdmSerializer
...
def registerAdmin(request):
    ...
    serializer = AdmSerializer(data=data)
    if serializer.is_valid():
